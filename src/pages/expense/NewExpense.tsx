    ...
    <div className="container col-md-4 col-sm-8 col-xs-12">
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="mb-3">
          ...
          {formik.touched.name && formik.errors.name ? (<div className="text-danger fst-italic">
        ...
        <Dropdown options={expenseCategories} id="category" name="category" label="Category"
          onChange={formik.handleChange} onBlur={formik.handleBlur} error={formik.errors.category}
          touched={formik.touched.category} value={formik.values.category}></Dropdown>
        <button className="btn bnt-sm btn-primary btn-outline-light" type="submit">Save</button>
      </form>
    </div>
  </div>
}
